    ...
    <div class="gaming-recharge-header">
        ...
        <div class="product-header d-flex">
            ...
            <div class="text-view-more">
                <a href="/dich-vu?service-option=1" class="global__link">Xem thêm<i class="__icon --sm --link ml-1" style="--path : url(/assets/frontend/{{theme('')->theme_key}}/image/svg/arrowright.svg)"></i></a>
            </div>
        </div>
    </div>
