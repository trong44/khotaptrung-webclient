    ...
    <div class="flash-sales c_block-product mt-fix-20 ">
        ...
        <span>
            ...
            <div class="text-view-more">
                <a href="/mua-acc?nick-option=3" class="global__link">Xem thêm<i class="__icon --sm --link ml-1" style="--path : url(/assets/frontend/{{theme('')->theme_key}}/image/svg/arrowright.svg)"></i></a>
            </div>
        </div>
